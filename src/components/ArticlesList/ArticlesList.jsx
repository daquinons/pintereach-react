...
import { getAllUserBoards, postArticle, getArticles } from '../../state/reducers/boards';
...
const ArticlesList = props => {
  const { userId, getAllUserBoards, boards, postArticle, isLoggedIn } = props;
      ...
      <div>
        <HeaderContainer>
          <Row>
            ...
            {owner ? (<Col className="text-md-right" sm={{ span: 1, offset: 7 }}>
